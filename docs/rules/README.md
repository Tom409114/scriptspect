...
| --- | --- | --- | --- | --- |
| [PS001](PS001.md) | POSIX_INLINE_ENV | error | high | cmd, powershell |
| [PS002](PS002.md) | CMD_SET_ENV | warn | high | posix-sh, powershell |
...
| [PS024](PS024.md) | CMD_VAR_EXPANSION | warn | high | posix-sh, powershell |
