...
- 本次最终核签所验证的实现 HEAD：`feat/v0.1-hardening` at `1be40498788de46c32df84b03a53fc15ce95778a`
...
| 候选提交的最终 CI | `HOSTED PENDING` | [PR #65](https://github.com/Tom409114/scriptspect/pull/65) 的 run `33443966280` 已通过 macOS Node 22/24、Node 24 integrations、dependency review、CodeQL、生成物、锁文件、打包消费与 benchmark；它继续暴露的 exact pinned-Node promotion claim 和 Action fixture shell quoting 已在当前实现 HEAD 修复，完整 rerun 尚待通过。 |
